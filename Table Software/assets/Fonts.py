...
HS_TEXT = pygame.font.Font(FONT_ORIGAMI, int(140 / 1440 * SCREEN_HEIGHT))
...
LARGER_TEXT = pygame.font.Font(FONT_RAJDHANI, int(6 / 144 * SCREEN_HEIGHT))
WRITTING_FONT = pygame.font.Font(FONT_RAJDHANI, int(4 / 144 * SCREEN_HEIGHT))