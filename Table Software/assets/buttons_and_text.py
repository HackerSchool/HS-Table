...
SMALL_BUTTON_WIDTH = int(SCREEN_HEIGHT * 0.9 // 12)
SMALL_BUTTON_HEIGHT = int(SCREEN_HEIGHT * 0.9 // 12)
...
MAIN_MENU_BUTTONS_LAYOUT_4 = [((SCREEN_WIDTH - BUTTON_WIDTH) // 2, SCREEN_HEIGHT * 5 // 12, BUTTON_WIDTH, BUTTON_HEIGHT),
                            ((SCREEN_WIDTH - BUTTON_WIDTH) // 2, SCREEN_HEIGHT * 6.5 // 12, BUTTON_WIDTH, BUTTON_HEIGHT),
                            ((SCREEN_WIDTH - BUTTON_WIDTH) // 2, SCREEN_HEIGHT * 8 // 12, BUTTON_WIDTH, BUTTON_HEIGHT),
                            ((SCREEN_WIDTH - BUTTON_WIDTH) // 2, SCREEN_HEIGHT * 9.5 // 12, BUTTON_WIDTH, BUTTON_HEIGHT)]
...
CHOOSE_SET_BUTTONS_LAYOUT = [(int(SCREEN_WIDTH * 0.50), int(SCREEN_HEIGHT // 6.5) * 1.2, SMALL_BUTTON_WIDTH, SMALL_BUTTON_WIDTH),
                             (int(SCREEN_WIDTH * 0.50 + SCREEN_WIDTH // 5 + 5 + SMALL_BUTTON_WIDTH), int(SCREEN_HEIGHT // 6.5) * 1.2, SMALL_BUTTON_WIDTH, SMALL_BUTTON_WIDTH),
                             (int(SCREEN_WIDTH * 0.50), int(SCREEN_HEIGHT // 6.5) * 2.2, SMALL_BUTTON_WIDTH, SMALL_BUTTON_WIDTH),
                             (int(SCREEN_WIDTH * 0.50 + SCREEN_WIDTH // 5 + 5 + SMALL_BUTTON_WIDTH), int(SCREEN_HEIGHT // 6.5) * 2.2, SMALL_BUTTON_WIDTH, SMALL_BUTTON_WIDTH),
                             (int(SCREEN_WIDTH * 0.50), int(SCREEN_HEIGHT // 6.5) * 3.2, SMALL_BUTTON_WIDTH, SMALL_BUTTON_WIDTH),
                             (int(SCREEN_WIDTH * 0.50 + SCREEN_WIDTH // 5 + 5 + SMALL_BUTTON_WIDTH), int(SCREEN_HEIGHT // 6.5) * 3.2, SMALL_BUTTON_WIDTH, SMALL_BUTTON_WIDTH),
                             (int(SCREEN_WIDTH * 0.50), int(SCREEN_HEIGHT // 6.5) * 1.5, SMALL_BUTTON_WIDTH, SMALL_BUTTON_WIDTH),
                             (int(SCREEN_WIDTH * 0.50 + SCREEN_WIDTH // 5 + 5 + SMALL_BUTTON_WIDTH), int(SCREEN_HEIGHT // 6.5) * 1.5, SMALL_BUTTON_WIDTH, SMALL_BUTTON_WIDTH),
                             (int(SCREEN_WIDTH * 0.50), int(SCREEN_HEIGHT // 6.5) * 2.5, SMALL_BUTTON_WIDTH, SMALL_BUTTON_WIDTH),
                             (int(SCREEN_WIDTH * 0.50 + SCREEN_WIDTH // 5 + 5 + SMALL_BUTTON_WIDTH), int(SCREEN_HEIGHT // 6.5) * 2.5, SMALL_BUTTON_WIDTH, SMALL_BUTTON_WIDTH),
                             ((SCREEN_WIDTH - BUTTON_WIDTH) // 2, SCREEN_HEIGHT * 8 // 12, BUTTON_WIDTH, BUTTON_HEIGHT),
