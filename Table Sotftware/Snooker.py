...
walls = [
    ...
    Border(HOLE_RADIUS + TABLE_WIDTH / 2, 0, TABLE_WIDTH / 2 - 3 * HOLE_RADIUS, BORDER_SIZE, WHITE), 
    Border(0, 2 * HOLE_RADIUS, BORDER_SIZE, TABLE_HEIGHT - 4 * HOLE_RADIUS, WHITE),
    Border(2 * HOLE_RADIUS, TABLE_HEIGHT - BORDER_SIZE, TABLE_WIDTH / 2 - 3 * HOLE_RADIUS, BORDER_SIZE, WHITE), 
    Border(HOLE_RADIUS + TABLE_WIDTH / 2, TABLE_HEIGHT - BORDER_SIZE, TABLE_WIDTH / 2 - 3 * HOLE_RADIUS, BORDER_SIZE, WHITE), 
    Border(TABLE_WIDTH - BORDER_SIZE, 2 * HOLE_RADIUS, BORDER_SIZE, TABLE_HEIGHT - 4 * HOLE_RADIUS, WHITE),
    ]

holes = [
    Hole(0, 0, HOLE_RADIUS, BLACK), 
    Hole(TABLE_WIDTH, TABLE_HEIGHT, HOLE_RADIUS, BLACK), 
    Hole(0, TABLE_HEIGHT, HOLE_RADIUS, BLACK), 
    Hole(TABLE_WIDTH, 0, HOLE_RADIUS, BLACK), 
...
balls = [
    ...
    Ball(TABLE_WIDTH // 2, TABLE_HEIGHT // 2, BALL_RADIUS, WHITE),
    Ball(TABLE_WIDTH // 2, TABLE_HEIGHT // 2 + 140, BALL_RADIUS, (randint(0, 255), randint(0, 255), randint(0, 255))),
    ]
